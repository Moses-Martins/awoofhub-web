...
export default function TrustSection({ offer }: Props) {
    return (
        <section className="border-t border-b border-gray-300 grid grid-cols-1 md:grid-cols-3 gap-8 py-5 items-start">
            {/* Store Info */}
            ...
            {/* Leave a Rating */}
            <div className="text-center border-x border-gray-300 px-4">

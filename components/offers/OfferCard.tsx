  ...
  return (
    ...
    <div key={offer.id} className="bg-white w-[300px] h-[450px] rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col group hover:shadow-md transition-shadow">
      ...
      <Link href={`/offers/${offer.id}`}
        className="w-full flex items-center justify-center bg-orange-600 text-white py-2.5 rounded-sm font-bold text-md hover:bg-orange-700 active:scale-95 transition-all">
        View More
      </Link>
    </div>

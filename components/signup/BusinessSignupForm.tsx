    ...
    return (
        <>
            <div className="text-left">
                ...
                <p className="font-baloo text-lg sm:text-2xl mt-3 text-lg text-slate-600">
            ...
            <form className="mt-7 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="text-center space-y-2">
                    <p className="text-gray-600 text-sm">
                        ...
                        <Link onClick={() => setRole("Business")} href="/signin" className="text-[#FF5700] font-semibold hover:underline">Sign in</Link>
                    </p>
                </div>

...
export default function ActivityCard({ type, title, isRead, createdAt, message, ...rest }: ActivityCardProps) {
    ...
    return (
        <div
            className={cn(
                "w-full cursor-pointer max-w-3xl mx-auto border border-gray-100 rounded-2xl p-3 sm:p-6 shadow-sm flex items-start gap-4 transition-colors",
            ...
            <div className="flex-grow">
                <div className="flex justify-between items-start mb-1">
                    ...
                    <span className="text-orange-500 text-xs sm:text-sm font-semibold whitespace-nowrap">

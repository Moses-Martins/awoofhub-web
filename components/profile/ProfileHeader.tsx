        ...
        <div className="max-w-5xl mx-auto p-4">
            ...
            <div className="bg-white rounded-3xl px-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="w-8 h-8 sm:w-40 sm:h-40 rounded-full overflow-hidden">
                    ...
                    <div className="flex flex-col justify-between gap-2 flex-1 pt-4">

                        <h1 className="text-2xl font-bold text-gray-900">{profile.name}</h1>

                        {profile.website &&
                            <p className="flex items-center gap-3 text-gray-500">
                                <RiLink size={20} /> <span className="flex items-center gap-3 text-blue-500 fond-medium">{profile.website}</span>
                            </p>
                        }
                    ...
                    {/* RIGHT SIDE (DROPDOWN) */}
                    {!isOwnProfile && (
                        <div ref={dropdownRef} className="relative mt-2 mb-auto">
